...
export const productConfigInputAllValues = async (
  ...
  await inputPage.inputTeamSlackChannelId('C1234567890')
...
export const productConfigInputDifferentValues = async (
  ...
  await inputPage.inputTeamSlackChannelId('C0987654321')
...
export const productConfigClearAllValues = async (inputPage: AdminProductConfigInputPage) => {
  ...
  await inputPage.inputTeamSlackChannelId('')
...
export const productConfigExpectAllInputsToBeEmpty = async (inputPage: AdminProductConfigInputPage) => {
  ...
  await expect(inputPage.teamSlackChannelIdTextbox).toHaveValue('')
...
export const productConfigExpectAllInputsFilled = async (inputPage: AdminProductConfigInputPage) => {
  ...
  await expect(inputPage.teamSlackChannelIdTextbox).toHaveValue('C1234567890')
...
export const productConfigExpectAllInputsFilledDifferent = async (inputPage: AdminProductConfigInputPage) => {
  ...
  await expect(inputPage.teamSlackChannelIdTextbox).toHaveValue('C0987654321')
  await expect(inputPage.prisonCategoryRadio).not.toBeChecked()
...
export const productConfigDetailsExpectAllSummary = async (detailsPage: AdminProductConfigDetailsPage) => {
  ...
  await expect(detailsPage.productConfigSummary).toContainText('C1111111111')
  ...
  await expect(detailsPage.serviceSummaryColumn).toContainText('Active')
  await expect(detailsPage.suspendedAtColumn).toContainText('N/A')
}
...
export const productSuspendedConfigDetailsExpectAllSummary = async (detailsPage: AdminProductConfigDetailsPage) => {
  ...
  await expect(detailsPage.productConfigSummary).toContainText('C9999999999')
