...
test.describe('Admin Product Configurations', () => {
  ...
  test('Displays the Suspended badge when a service is suspended', async ({ page }) => {
    await resetStubs()
    ...
    await expect(productConfigPage.productsTableRow(0)).toBeVisible()
    await expect(productConfigPage.productsTableCell(0, 0)).toContainText('service-ninety-nine')
    await expect(productConfigPage.productsTableCell(0, 1)).toContainText('Service Ninety Nine')
    await expect(productConfigPage.productsTableCell(0, 2)).toContainText('http://service-ninety-nine')
    await expect(productConfigPage.productsTableCell(0, 3)).toContainText('PROBATION')
    await expect(productConfigPage.productsTableCell(0, 4)).toContainText('Enabled')
    await expect(productConfigPage.productsTableCell(0, 5)).toContainText('Not migrated')
    await expect(productConfigPage.productsTableCell(0, 6)).toContainText('Suspended')

    await expect(productConfigPage.productsTableRow(1)).toBeVisible()
    await expect(productConfigPage.productsTableCell(1, 0)).toContainText('service-one')
    await expect(productConfigPage.productsTableCell(1, 1)).toContainText('Service One')
    await expect(productConfigPage.productsTableCell(1, 2)).toContainText('http://service-one')
    await expect(productConfigPage.productsTableCell(1, 3)).toContainText('PRISON')
    await expect(productConfigPage.productsTableCell(1, 4)).toContainText('Enabled')
    await expect(productConfigPage.productsTableCell(1, 5)).toContainText('Migrated')
    await expect(productConfigPage.productsTableCell(1, 6)).toContainText('Active')
