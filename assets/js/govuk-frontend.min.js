...
function normaliseString(e, t) {
  ...
  switch (
    (s || (['true', 'false'].includes(n) && (s = 'boolean'), n.length > 0 && isFinite(Number(n)) && (s = 'number')), s)
  ) {
    case 'boolean':
      i = 'true' === n
      break
...
function extractConfigByNamespace(e, t, n) {
  ...
  for (const [o, r] of Object.entries(t)) {
    ...
    for (const [i, s] of t.entries())
      'object' == typeof e &&
        (i < t.length - 1 ? (isObject(e[s]) || (e[s] = {}), (e = e[s])) : o !== n && (e[s] = normaliseString(r)))
  }
  return s[n]
}
...
function getBreakpoint(e) {
  ...
  return { property: t, value: window.getComputedStyle(document.documentElement).getPropertyValue(t) || void 0 }
}
...
function normaliseDataset(e, t) {
  ...
  for (const [i, s] of Object.entries(e.schema.properties))
    i in t && (n[i] = normaliseString(t[i], s)),
      'object' === (null == s ? void 0 : s.type) && (n[i] = extractConfigByNamespace(e, t, i))
  return n
}
...
class ElementError extends GOVUKFrontendError {
  constructor(e) {
    ...
    if ('object' == typeof e) {
      const { componentName: n, identifier: i, element: s, expectedType: o } = e
...
class I18n {
  constructor(e = {}, t = {}) {
    ...
    ;(this.translations = void 0),
      (this.locale = void 0),
      (this.translations = e),
      (this.locale = null != (n = t.locale) ? n : document.documentElement.lang || 'en')
  }
  t(e, t) {
  ...
  getPluralSuffix(e, t) {
    ...
    if ('object' == typeof n) {
      ...
      if ('other' in n)
        return (
          console.warn(`i18n: Missing plural form ".${i}" for "${this.locale}" locale. Falling back to ".other".`),
          'other'
        )
    }
...
class Accordion extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if (
      ...
      throw new ElementError({ componentName: 'Accordion', element: e, identifier: 'Root element (`$module`)' })
    ;(this.$module = e),
      (this.config = mergeConfigs(Accordion.defaults, t, normaliseDataset(Accordion, e.dataset))),
...
;(Accordion.moduleName = 'govuk-accordion'),
  ...
  (Accordion.schema = Object.freeze({
    properties: { i18n: { type: 'object' }, rememberExpanded: { type: 'boolean' } },
  }))
class Button extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if (
      ...
      throw new ElementError({ componentName: 'Button', element: e, identifier: 'Root element (`$module`)' })
    ;(this.$module = e),
...
;(Button.moduleName = 'govuk-button'),
  ...
  (Button.schema = Object.freeze({ properties: { preventDoubleClick: { type: 'boolean' } } }))
class CharacterCount extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    if (
      ...
      throw new ElementError({ componentName: 'Character count', element: e, identifier: 'Root element (`$module`)' })
    ...
    const a = (function (e, t) {
      ...
      for (const [i, s] of Object.entries(e)) {
        const e = []
        if (Array.isArray(s)) {
          for (const { required: n, errorMessage: i } of s) n.every(e => !!t[e]) || e.push(i)
    ...
    ;(this.i18n = new I18n(this.config.i18n, { locale: closestAttributeValue(e, 'lang') })),
      (this.maxLength = null != (n = null != (i = this.config.maxwords) ? i : this.config.maxlength) ? n : 1 / 0),
      (this.$module = e),
      (this.$textarea = s)
    ...
    ;`${c.textContent}`.match(/^\s*$/) &&
      (c.textContent = this.i18n.t('textareaDescription', { count: this.maxLength })),
...
class Checkboxes extends GOVUKFrontendComponent {
  constructor(e) {
    if ((super(), (this.$module = void 0), (this.$inputs = void 0), !(e instanceof HTMLElement)))
      throw new ElementError({ componentName: 'Checkboxes', element: e, identifier: 'Root element (`$module`)' })
    const t = e.querySelectorAll('input[type="checkbox"]')
    if (!t.length)
      throw new ElementError({ componentName: 'Checkboxes', identifier: 'Form inputs (`<input type="checkbox">`)' })
    ;(this.$module = e),
      (this.$inputs = t),
      this.$inputs.forEach(e => {
        ...
        if (t) {
          if (!document.getElementById(t))
            throw new ElementError({ componentName: 'Checkboxes', identifier: `Conditional reveal (\`id="${t}"\`)` })
...
class ErrorSummary extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if ((super(), (this.$module = void 0), (this.config = void 0), !(e instanceof HTMLElement)))
      throw new ElementError({ componentName: 'Error summary', element: e, identifier: 'Root element (`$module`)' })
    ;(this.$module = e),
      (this.config = mergeConfigs(ErrorSummary.defaults, t, normaliseDataset(ErrorSummary, e.dataset))),
...
;(ErrorSummary.moduleName = 'govuk-error-summary'),
  ...
  (ErrorSummary.schema = Object.freeze({ properties: { disableAutoFocus: { type: 'boolean' } } }))
class ExitThisPage extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if (
      ...
      throw new ElementError({ componentName: 'Exit this page', element: e, identifier: 'Root element (`$module`)' })
    ...
    ;(this.config = mergeConfigs(ExitThisPage.defaults, t, normaliseDataset(ExitThisPage, e.dataset))),
      (this.i18n = new I18n(this.config.i18n)),
      (this.$module = e),
      (this.$button = n)
...
class Header extends GOVUKFrontendComponent {
  constructor(e) {
    if (
      ...
      throw new ElementError({ componentName: 'Header', element: e, identifier: 'Root element (`$module`)' })
    this.$module = e
    ...
    if (!i)
      throw new ElementError({ componentName: 'Header', element: i, identifier: `Navigation (\`<ul id="${n}">\`)` })
    ;(this.$menu = i),
      (this.$menuButton = t),
...
class NotificationBanner extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    ...
    ;(this.$module = e),
      (this.config = mergeConfigs(NotificationBanner.defaults, t, normaliseDataset(NotificationBanner, e.dataset))),
...
;(NotificationBanner.moduleName = 'govuk-notification-banner'),
  ...
  (NotificationBanner.schema = Object.freeze({ properties: { disableAutoFocus: { type: 'boolean' } } }))
class PasswordInput extends GOVUKFrontendComponent {
  constructor(e, t = {}) {
    if (
      ...
      throw new ElementError({ componentName: 'Password input', element: e, identifier: 'Root element (`$module`)' })
    ...
    ;(this.$module = e),
      ...
      (this.config = mergeConfigs(PasswordInput.defaults, t, normaliseDataset(PasswordInput, e.dataset))),
      (this.i18n = new I18n(this.config.i18n, { locale: closestAttributeValue(e, 'lang') })),
  ...
  setType(e) {
    ...
    ;(this.$showHideButton.innerText = this.i18n.t(`${n}Password`)),
      this.$showHideButton.setAttribute('aria-label', this.i18n.t(`${n}PasswordAriaLabel`)),
      (this.$screenReaderStatusMessage.innerText = this.i18n.t(`${i}Announcement`))
  }
}
...
class Radios extends GOVUKFrontendComponent {
  constructor(e) {
    if ((super(), (this.$module = void 0), (this.$inputs = void 0), !(e instanceof HTMLElement)))
      throw new ElementError({ componentName: 'Radios', element: e, identifier: 'Root element (`$module`)' })
    const t = e.querySelectorAll('input[type="radio"]')
    if (!t.length)
      throw new ElementError({ componentName: 'Radios', identifier: 'Form inputs (`<input type="radio">`)' })
    ;(this.$module = e),
      (this.$inputs = t),
      this.$inputs.forEach(e => {
        const t = e.getAttribute('data-aria-controls')
        if (t) {
          if (!document.getElementById(t))
            throw new ElementError({ componentName: 'Radios', identifier: `Conditional reveal (\`id="${t}"\`)` })
          e.setAttribute('aria-controls', t), e.removeAttribute('data-aria-controls')
        }
      }),
      window.addEventListener('pageshow', () => this.syncAllConditionalReveals()),
...
class SkipLink extends GOVUKFrontendComponent {
  constructor(e) {
    ...
    if (!r)
      throw new ElementError({ componentName: 'Skip link', element: r, identifier: `Target content (\`id="${o}"\`)` })
...
class Tabs extends GOVUKFrontendComponent {
  constructor(e) {
    if (
      ...
      throw new ElementError({ componentName: 'Tabs', element: e, identifier: 'Root element (`$module`)' })
    const t = e.querySelectorAll('a.govuk-tabs__tab')
    if (!t.length)
      throw new ElementError({ componentName: 'Tabs', identifier: 'Links (`<a class="govuk-tabs__tab">`)' })
    ;(this.$module = e),
      (this.$tabs = t),
    ...
    if (!n) throw new ElementError({ componentName: 'Tabs', identifier: 'List (`<ul class="govuk-tabs__list">`)' })
    if (!i.length)
      throw new ElementError({ componentName: 'Tabs', identifier: 'List items (`<li class="govuk-tabs__list-item">`)' })
  ...
  onTabClick(e) {
    ...
    t &&
      ...
      (e.preventDefault(), this.hideTab(t), this.showTab(n), this.createHistoryEntry(n))
  }
